...
struct SearchView: View {
    ...
    var body: some View {
		SearchContentView(state: viewModel.state, itemAction: viewModel.itemAction(_:))
	...
	final class ViewModel: ObservableObject {
		...
		/// Handles the navigation within the `Search` flow.
		...
		init(coordinator: SearchCoordinator?, api: ItunesSearchServiceProtocol) {
